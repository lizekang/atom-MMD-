...
module.exports = MikuView = ( function() {
    function MikuView(serializedState) {
        ...
        * */
        ...
        iframe.src = 'http://localhost:63342/MMD/index.html' + '?num=' + Math.random;
        ...
        * */
        ...
        girlmodle.classList.add('miku_girl');
        girlmodle.classList.add('miku_btn');
        girlmodle.id = 'girlmodle' + this.randomId;
        girlmodle.setAttribute('name','change');
        girlmodle.innerHTML = '萌妹模式';
    ...
    * */
    ...
    MikuView.prototype.bugappear = function(bugs) {
        if (this.miku && this.miku.control) {
            this.miku.control.bugappear(bugs);
        }
    };
    MikuView.prototype.change = function(){
      if (this.miku && this.miku.control){
        this.miku.control.change();
      }
    };
    ...
    MikuView.prototype.pause = function(flag) {
        if (this.miku && this.miku.control) {
            this.miku.control.pause(flag);
        }
    };
